...
class LoginMode(sgqlc.types.Enum):
    __schema__ = platform_schema
    __choices__ = ('ACCOUNT_PASSWORD', 'DINGDING', 'EMAIL_PASSWORD', 'PHONE_VERIFY_CODE', 'WECHAT')
...
class AccountListFilterInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = ('is_allowed_to_login', 'roles', 'search', 'search_by')
...
class ApplyForTenantCertificationInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = ('business_license_image',)
...
class CreateFeaturePackInput(sgqlc.types.Input):
    ...
    applicable_industries = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('StringIDInput'))), graphql_name='applicableIndustries')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    remark = sgqlc.types.Field(String, graphql_name='remark')
...
class FeaturePackListFilterInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = ('industries', 'search')
...
class PermissionFilterInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = ('app_keys', 'exclude_app_keys', 'ids', 'is_leaf_only', 'require_data_ranges', 'types')
...
class Mutation(sgqlc.types.Type):
    ...
    sign_up_tenant = sgqlc.types.Field(sgqlc.types.non_null(AuthInfo), graphql_name='signUpTenant', args=sgqlc.types.ArgDict((
    ...
    unbind_wecom_user = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='unbindWecomUser', args=sgqlc.types.ArgDict((
        ('account_id', sgqlc.types.Arg(String, graphql_name='accountId', default=None)),
))
    )
...
class Staff(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('account', 'avatar', 'created_at', 'email', 'id', 'job_status', 'job_type', 'name', 'organizations', 'phone_number', 'remark', 'tenant', 'updated_at')
