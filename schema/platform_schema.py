...
class AssignAppPermissionsInput(sgqlc.types.Input):
    ...
    permissions = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('StringIDInput'))),
...
class AssignTenantAppsInput(sgqlc.types.Input):
    ...
    apps = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('StringIDInput'))),
                             graphql_name='apps')
...
class AuthorizationRuleFilterInput(sgqlc.types.Input):
    ...
    permission_types = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(PermissionType)),
                                         graphql_name='permissionTypes')
...
class ConfigureAuthenticationSourceLDAP3Input(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'bind_dn', 'bind_password', 'company_id', 'email_attribute', 'encryption_method', 'host', 'is_active', 'name',
    'name_attribute', 'phone_attribute', 'port', 'uid_attribute', 'user_search_base_dn', 'user_search_filter')
...
class ConfigureAuthenticationSourceOAuth2Input(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'authorization_url', 'client_id', 'client_secret', 'company_id', 'email_attribute', 'is_active', 'name',
    'name_attribute', 'phone_attribute', 'scope', 'token_url', 'uid_attribute', 'user_info_url')
...
class ConfigureAuthenticationSourceOpenIDConnect1Input(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'authorization_url', 'client_id', 'client_secret', 'company_id', 'configuration_method', 'configuration_url',
    'email_attribute', 'is_active', 'jwks_url', 'name', 'name_attribute', 'phone_attribute', 'scope', 'token_url',
    'uid_attribute')
    authorization_url = sgqlc.types.Field(String, graphql_name='authorizationURL')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientID')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    company_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='companyId')
    configuration_method = sgqlc.types.Field(sgqlc.types.non_null(OpenIDConnect1ConfigurationMethod),
                                             graphql_name='configurationMethod')
...
class ContentInput(sgqlc.types.Input):
    ...
    targets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('FieldInput'))),
...
class CreateCompanyBIDatasourceInput(sgqlc.types.Input):
    ...
    datasource = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('IDInput'))),
...
class CreateMetaTemplateInput(sgqlc.types.Input):
    ...
    contents = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(ContentInput))),
    ...
    render_styles = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('RenderStyleInput'))),
        graphql_name='renderStyles')


class CreateOAuth2AuthenticationConfigurationInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'access_token_attribute_path', 'account_attribute_path', 'authorization_url', 'client_authentication_method',
    'client_id', 'client_secret', 'do_update_local_user_info_when_login', 'email_attribute_path', 'is_active', 'name',
    'name_attribute_path', 'phone_number_attribute_path', 'scope', 'support_state', 'token_response_format',
    'token_url', 'user_info_authentication_method', 'user_info_request_method', 'user_info_response_format',
    'user_info_url')
    access_token_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                    graphql_name='accessTokenAttributePath')
    account_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='accountAttributePath')
    authorization_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='authorizationUrl')
    client_authentication_method = sgqlc.types.Field(sgqlc.types.non_null(AuthenticationMethod),
                                                     graphql_name='clientAuthenticationMethod')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientId')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    do_update_local_user_info_when_login = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                             graphql_name='doUpdateLocalUserInfoWhenLogin')
    ...
    token_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='tokenUrl')
    user_info_authentication_method = sgqlc.types.Field(sgqlc.types.non_null(AuthenticationMethod),
                                                        graphql_name='userInfoAuthenticationMethod')
    user_info_request_method = sgqlc.types.Field(sgqlc.types.non_null(UserInfoRequestMethod),
                                                 graphql_name='userInfoRequestMethod')
    user_info_response_format = sgqlc.types.Field(sgqlc.types.non_null(ResponseFormat),
                                                  graphql_name='userInfoResponseFormat')
    user_info_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='userInfoUrl')
...
class CreateOpenIDConnect1AuthenticationConfigurationInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'account_attribute_path', 'client_id', 'client_secret', 'configuration_url', 'do_update_local_user_info_when_login',
    'email_attribute_path', 'is_active', 'kind', 'name', 'name_attribute_path', 'phone_number_attribute_path', 'scope')
    account_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='accountAttributePath')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientId')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    configuration_url = sgqlc.types.Field(String, graphql_name='configurationUrl')
...
class CreateTenantInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'address', 'city', 'code', 'county', 'email', 'industry', 'name', 'phone', 'province', 'type', 'uscc')
...
class CreateUserInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'account', 'email', 'is_account_enabled', 'name', 'organizations', 'phone_number', 'remark', 'roles')
    account = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='account')
    email = sgqlc.types.Field(String, graphql_name='email')
    is_account_enabled = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isAccountEnabled')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    organizations = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('StringIDInput'))),
...
class DuplicateUCCFormStructureInput(sgqlc.types.Input):
    ...
    company = sgqlc.types.Field(sgqlc.types.non_null('IDInput'), graphql_name='company')
    key_pair = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('DuplicateUCCFormStructureKeyInput')),
                                 graphql_name='keyPair')
...
class SetAuthorizationRulesToRoleInput(sgqlc.types.Input):
    ...
    authorization_rules = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(SetAuthorizationRuleInput))),
        graphql_name='authorizationRules')
...
class SetTableFieldsConfigInput(sgqlc.types.Input):
    ...
    fields = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('TableFieldConfigInput'))),
                               graphql_name='fields')
...
class UCCFieldInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'content', 'default_bool', 'default_num', 'default_str', 'default_str_list', 'field_type', 'format', 'hint', 'id',
    'label', 'max', 'max_range', 'min', 'min_range', 'multi', 'name', 'option', 'required', 'role', 'round', 'set',
    'type', 'unit', 'width', 'zeroable')
    ...
    default_str_list = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(String)),
                                         graphql_name='defaultStrList')
...
class UpdateAuthorizationRulesOfUserInput(sgqlc.types.Input):
    ...
    __field_names__ = ('authorization_rules', 'user')
    authorization_rules = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(UpdateAuthorizationRuleInput))),
        graphql_name='authorizationRules')
    user = sgqlc.types.Field(sgqlc.types.non_null(StringIDInput), graphql_name='user')
...
class UpdateMetaTemplateInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'contents', 'description', 'event', 'fields', 'id', 'name', 'push_schedule', 'render_styles', 'status', 'tenant_id')
    ...
    name = sgqlc.types.Field(String, graphql_name='name')
    push_schedule = sgqlc.types.Field(PushScheduleInput, graphql_name='pushSchedule')
    render_styles = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(RenderStyleInput)),
                                      graphql_name='renderStyles')
...
class UpdateOAuth2AuthenticationConfigurationInput(sgqlc.types.Input):
    ...
    __field_names__ = (
    'access_token_attribute_path', 'account_attribute_path', 'authorization_url', 'client_authentication_method',
    'client_id', 'client_secret', 'do_update_local_user_info_when_login', 'email_attribute_path', 'id', 'is_active',
    'name', 'name_attribute_path', 'phone_number_attribute_path', 'scope', 'support_state', 'token_response_format',
    'token_url', 'user_info_authentication_method', 'user_info_request_method', 'user_info_response_format',
    'user_info_url')
    ...
    token_url = sgqlc.types.Field(String, graphql_name='tokenUrl')
    user_info_authentication_method = sgqlc.types.Field(AuthenticationMethod,
                                                        graphql_name='userInfoAuthenticationMethod')
...
class UpdateOpenIDConnect1AuthenticationConfigurationInput(sgqlc.types.Input):
    ...
    __field_names__ = (
    'account_attribute_path', 'client_id', 'client_secret', 'configuration_url', 'do_update_local_user_info_when_login',
    'email_attribute_path', 'id', 'is_active', 'name', 'name_attribute_path', 'phone_number_attribute_path', 'scope')
    account_attribute_path = sgqlc.types.Field(String, graphql_name='accountAttributePath')
    client_id = sgqlc.types.Field(String, graphql_name='clientId')
    client_secret = sgqlc.types.Field(String, graphql_name='clientSecret')
    configuration_url = sgqlc.types.Field(String, graphql_name='configurationUrl')
...
class UpdateTenantInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'address', 'city', 'code', 'county', 'email', 'id', 'industry', 'name', 'phone', 'province', 'uscc')
    address = sgqlc.types.Field(String, graphql_name='address')
    city = sgqlc.types.Field(StringIDInput, graphql_name='city')
    code = sgqlc.types.Field(String, graphql_name='code')
...
class UpdateUserInput(sgqlc.types.Input):
    ...
    name = sgqlc.types.Field(String, graphql_name='name')
    organizations = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(StringIDInput)),
                                      graphql_name='organizations')
    phone_number = sgqlc.types.Field(String, graphql_name='phoneNumber')
    remark = sgqlc.types.Field(String, graphql_name='remark')
    roles = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(StringIDInput)), graphql_name='roles')
...
class UserFilterInput(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'accounts', 'include_children_organizations', 'include_disabled_users', 'is_account_enabled', 'is_admin',
    'organizations', 'roles', 'search')
...
class UserListFilter(sgqlc.types.Input):
    __schema__ = platform_schema
    __field_names__ = (
    'company', 'current_only', 'department', 'ids', 'is_active', 'role', 'search', 'search_name', 'type', 'uid')
...
class App(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'avatar', 'client_id', 'client_secret', 'code', 'description', 'dispatched_permissions', 'group', 'id', 'jump_kind',
    'kind', 'name', 'online_version', 'order', 'redirect_url', 'url', 'versions')
    avatar = sgqlc.types.Field('Image', graphql_name='avatar')
    client_id = sgqlc.types.Field(String, graphql_name='clientId')
    client_secret = sgqlc.types.Field(String, graphql_name='clientSecret')
    code = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='code')
    description = sgqlc.types.Field(String, graphql_name='description')
    dispatched_permissions = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('Permission')),
                                               graphql_name='dispatchedPermissions')
...
class AppBIDatasourceList(sgqlc.types.Type):
    ...
    datasource = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('BIDatasource'))),
                                   graphql_name='datasource')
...
class AppGroup(sgqlc.types.Type):
    ...
    app_ids = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                graphql_name='appIds')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class AppMenu(sgqlc.types.Type):
    ...
    app = sgqlc.types.Field(App, graphql_name='app')
    menus = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('Menu'))),
                              graphql_name='menus')
...
class AppMenuList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AppMenu))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class AppVersionDifference(sgqlc.types.Type):
    ...
    perm_diffs = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('AppVersionPermDiff'))), graphql_name='permDiffs')


class AppVersionList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AppVersion))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class AppVersionSnapshot(sgqlc.types.Type):
    ...
    perm_snapshot = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('Permission'))),
                                      graphql_name='permSnapshot')
...
class Authorization(sgqlc.types.Type):
    ...
    data_ranges = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                    graphql_name='dataRanges')
...
class AuthorizationRuleList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AuthorizationRule))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class Company(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'address', 'city', 'contact', 'county', 'email', 'id', 'is_mine', 'name', 'phone', 'province', 'type', 'uid',
    'uscc')
    address = sgqlc.types.Field(String, graphql_name='address')
...
class Content(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('targets', 'template', 'url')
    targets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('Field'))),
                                graphql_name='targets')
    template = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='template')
    url = sgqlc.types.Field(String, graphql_name='url')
...
class InboxMessageList(sgqlc.types.Type):
    ...
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(InboxMessage))),
                             graphql_name='data')
...
class Log(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'account', 'action', 'app', 'code', 'details', 'feature', 'id', 'ip', 'location', 'occurred_at', 'payload',
    'tenant_id')
    account = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='account')
...
class MenuVisitHistoryList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MenuVisitHistory))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class MessageChannel(sgqlc.types.Type):
    ...
    available_message_kind = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageKind))),
        graphql_name='availableMessageKind')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class MessageTemplate(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'app', 'available_channels', 'contents', 'description', 'event', 'fields', 'id', 'name', 'render_styles',
    'selected_channels', 'tenant_id')
    app = sgqlc.types.Field(sgqlc.types.non_null(App), graphql_name='app')
    available_channels = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageChannel))),
        graphql_name='availableChannels')
    contents = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Content))),
                                 graphql_name='contents')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
    event = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='event')
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    render_styles = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('RenderStyle'))),
                                      graphql_name='renderStyles')
    selected_channels = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageChannel))),
        graphql_name='selectedChannels')
    tenant_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='tenantId')
...
class MessageTemplateList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageTemplate))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class MetaChannel(sgqlc.types.Type):
    ...
    available_message_kinds = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageKind))),
        graphql_name='availableMessageKinds')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class MetaTemplate(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'app', 'available_channels', 'contents', 'description', 'event', 'fields', 'has_updates', 'id', 'name',
    'push_schedule', 'render_styles', 'status')
    app = sgqlc.types.Field(sgqlc.types.non_null(App), graphql_name='app')
    available_channels = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageChannel))),
        graphql_name='availableChannels')
...
class MetaTemplateList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MetaTemplate))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class Mutation(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    '_dummy', 'active_message_channel', 'add_meta_templates_to_tenant', 'assign_app_permissions', 'assign_tenant_apps',
    'change_my_password', 'company_login', 'configure_authentication_source_ldap3',
    'configure_authentication_source_oauth2', 'configure_authentication_source_open_idconnect1',
    'configure_authentication_source_saml2', 'create_app_version', 'create_company_bidatasource',
    'create_enterprise_app', 'create_file', 'create_files', 'create_image', 'create_images', 'create_market_file',
    'create_market_files', 'create_meta_template', 'create_oauth2_authentication_configuration',
    'create_open_idconnect1_authentication_configuration', 'create_organization', 'create_role', 'create_tenant',
    'create_tenant_owner', 'create_user', 'deactivate_message_channel', 'delete_app_version',
    'delete_authentication_configuration', 'delete_company_bidatasource', 'delete_enterprise_apps',
    'delete_message_templates_of_tenant', 'delete_meta_template', 'delete_organization', 'delete_role',
    'delete_table_fields_config', 'delete_tenant', 'delete_users', 'disable_tenant', 'disable_users',
    'duplicate_uccform_structure', 'enable_tenant', 'enable_users', 'login', 'logout', 'offline_app_version',
    'online_app_version', 'overwrite_message_template', 'read_all_inbox_messages', 'read_inbox_messages',
    'remove_authorization_rules_of_user', 'reset_app_client_secret', 'reset_authentication_source',
    'reset_tenant_owner_password', 'reset_user_password', 'set_admin_users', 'set_authorization_rules_to_role',
    'set_authorization_rules_to_user', 'set_channel_of_message_templates', 'set_channels_of_message_template',
    'set_permissions_to_tenant', 'set_table_fields_config', 'set_uccform_structure', 'set_workbench', 'star_app',
    'transfer_tenant_owner', 'un_assign_app_permissions', 'un_assign_tenant_apps', 'un_star_app', 'unset_admin_users',
    'update_app_version', 'update_authorization_rules_of_user', 'update_enterprise_app', 'update_me',
    'update_meta_channel', 'update_meta_template', 'update_oauth2_authentication_configuration',
    'update_open_idconnect1_authentication_configuration', 'update_organization', 'update_role',
    'update_status_of_template', 'update_tenant', 'update_user', 'visit_app', 'visit_menu')
    _dummy = sgqlc.types.Field(Boolean, graphql_name='_dummy')
    active_message_channel = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='activeMessageChannel',
                                               args=sgqlc.types.ArgDict((
                                                   ('id',
                                                    sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                    default=None)),
                                               ))
                                               )
    add_meta_templates_to_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                     graphql_name='addMetaTemplatesToTenant', args=sgqlc.types.ArgDict((
            ('ids',
             sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name='ids', default=None)),
            ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId', default=None)),
        ))
                                                     )
    assign_app_permissions = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='assignAppPermissions',
                                               args=sgqlc.types.ArgDict((
                                                   ('input',
                                                    sgqlc.types.Arg(sgqlc.types.non_null(AssignAppPermissionsInput),
                                                                    graphql_name='input', default=None)),
                                               ))
                                               )
    assign_tenant_apps = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='assignTenantApps',
                                           args=sgqlc.types.ArgDict((
                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(AssignTenantAppsInput),
                                                                         graphql_name='input', default=None)),
                                           ))
                                           )
    change_my_password = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='changeMyPassword',
                                           args=sgqlc.types.ArgDict((
                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(ChangeMyPasswordInput),
                                                                         graphql_name='input', default=None)),
                                           ))
                                           )
    company_login = sgqlc.types.Field(sgqlc.types.non_null(AuthInfo), graphql_name='companyLogin',
                                      args=sgqlc.types.ArgDict((
                                          ('input', sgqlc.types.Arg(sgqlc.types.non_null(CompanyLoginInput),
                                                                    graphql_name='input', default=None)),
                                      ))
                                      )
    configure_authentication_source_ldap3 = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                              graphql_name='configureAuthenticationSourceLDAP3',
                                                              args=sgqlc.types.ArgDict((
                                                                  ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                      ConfigureAuthenticationSourceLDAP3Input),
                                                                                            graphql_name='input',
                                                                                            default=None)),
                                                              ))
                                                              )
    configure_authentication_source_oauth2 = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                               graphql_name='configureAuthenticationSourceOAuth2',
                                                               args=sgqlc.types.ArgDict((
                                                                   ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                       ConfigureAuthenticationSourceOAuth2Input),
                                                                                             graphql_name='input',
                                                                                             default=None)),
                                                               ))
                                                               )
    configure_authentication_source_open_idconnect1 = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                                        graphql_name='configureAuthenticationSourceOpenIDConnect1',
                                                                        args=sgqlc.types.ArgDict((
                                                                            ('input', sgqlc.types.Arg(
                                                                                sgqlc.types.non_null(
                                                                                    ConfigureAuthenticationSourceOpenIDConnect1Input),
                                                                                graphql_name='input', default=None)),
                                                                        ))
                                                                        )
    configure_authentication_source_saml2 = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                              graphql_name='configureAuthenticationSourceSAML2',
                                                              args=sgqlc.types.ArgDict((
                                                                  ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                      ConfigureAuthenticationSourceSAML2Input),
                                                                                            graphql_name='input',
                                                                                            default=None)),
                                                              ))
                                                              )
    create_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='createAppVersion',
                                           args=sgqlc.types.ArgDict((
                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(CreateAppVersionInput),
                                                                         graphql_name='input', default=None)),
                                           ))
                                           )
    create_company_bidatasource = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                    graphql_name='createCompanyBIDatasource', args=sgqlc.types.ArgDict((
            ('input',
             sgqlc.types.Arg(sgqlc.types.non_null(CreateCompanyBIDatasourceInput), graphql_name='input', default=None)),
        ))
                                                    )
    create_enterprise_app = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='createEnterpriseApp',
                                              args=sgqlc.types.ArgDict((
                                                  ('input',
                                                   sgqlc.types.Arg(sgqlc.types.non_null(CreateEnterpriseAppInput),
                                                                   graphql_name='input', default=None)),
                                              ))
                                              )
    ...
    create_files = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(File)), graphql_name='createFiles',
                                     args=sgqlc.types.ArgDict((
                                         ('input',
                                          sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(CreateFileInput)),
                                                          graphql_name='input', default=None)),
                                     ))
                                     )
    ...
    create_images = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(Image)), graphql_name='createImages',
                                      args=sgqlc.types.ArgDict((
                                          ('input',
                                           sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(CreateImageInput)),
                                                           graphql_name='input', default=None)),
                                      ))
                                      )
    create_market_file = sgqlc.types.Field(sgqlc.types.non_null(File), graphql_name='createMarketFile',
                                           args=sgqlc.types.ArgDict((
                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(CreateMarketFileInput),
                                                                         graphql_name='input', default=None)),
                                           ))
                                           )
    create_market_files = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(File)),
                                            graphql_name='createMarketFiles', args=sgqlc.types.ArgDict((
            ('input',
             sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(CreateMarketFileInput)), graphql_name='input',
                             default=None)),
        ))
                                            )
    create_meta_template = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='createMetaTemplate',
                                             args=sgqlc.types.ArgDict((
                                                 ('input',
                                                  sgqlc.types.Arg(sgqlc.types.non_null(CreateMetaTemplateInput),
                                                                  graphql_name='input', default=None)),
                                             ))
                                             )
    create_oauth2_authentication_configuration = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                                   graphql_name='createOAuth2AuthenticationConfiguration',
                                                                   args=sgqlc.types.ArgDict((
                                                                       ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                           CreateOAuth2AuthenticationConfigurationInput),
                                                                                                 graphql_name='input',
                                                                                                 default=None)),
                                                                   ))
                                                                   )
    create_open_idconnect1_authentication_configuration = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                                            graphql_name='createOpenIDConnect1AuthenticationConfiguration',
                                                                            args=sgqlc.types.ArgDict((
                                                                                ('input', sgqlc.types.Arg(
                                                                                    sgqlc.types.non_null(
                                                                                        CreateOpenIDConnect1AuthenticationConfigurationInput),
                                                                                    graphql_name='input',
                                                                                    default=None)),
                                                                            ))
                                                                            )
    create_organization = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='createOrganization',
                                            args=sgqlc.types.ArgDict((
                                                ('input', sgqlc.types.Arg(sgqlc.types.non_null(CreateOrganizationInput),
                                                                          graphql_name='input', default=None)),
                                            ))
                                            )
    ...
    create_tenant = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='createTenant',
                                      args=sgqlc.types.ArgDict((
                                          ('input', sgqlc.types.Arg(sgqlc.types.non_null(CreateTenantInput),
                                                                    graphql_name='input', default=None)),
                                      ))
                                      )
    create_tenant_owner = sgqlc.types.Field(sgqlc.types.non_null(CreatedUserInfo), graphql_name='createTenantOwner',
                                            args=sgqlc.types.ArgDict((
                                                ('input', sgqlc.types.Arg(sgqlc.types.non_null(CreateTenantOwnerInput),
                                                                          graphql_name='input', default=None)),
                                            ))
                                            )
    create_user = sgqlc.types.Field(sgqlc.types.non_null(CreatedUserInfo), graphql_name='createUser',
                                    args=sgqlc.types.ArgDict((
                                        ('input',
                                         sgqlc.types.Arg(sgqlc.types.non_null(CreateUserInput), graphql_name='input',
                                                         default=None)),
                                    ))
                                    )
    deactivate_message_channel = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                   graphql_name='deactivateMessageChannel', args=sgqlc.types.ArgDict((
            ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id', default=None)),
        ))
                                                   )
    delete_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteAppVersion',
                                           args=sgqlc.types.ArgDict((
                                               ('ids', sgqlc.types.Arg(sgqlc.types.non_null(
                                                   sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                       graphql_name='ids', default=None)),
                                           ))
                                           )
    delete_authentication_configuration = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                            graphql_name='deleteAuthenticationConfiguration',
                                                            args=sgqlc.types.ArgDict((
                                                                ('id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                       graphql_name='id',
                                                                                       default=None)),
                                                            ))
                                                            )
    delete_company_bidatasource = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                    graphql_name='deleteCompanyBIDatasource', args=sgqlc.types.ArgDict((
            ('id',
             sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(ID))), graphql_name='id',
                             default=None)),
        ))
                                                    )
    delete_enterprise_apps = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteEnterpriseApps',
                                               args=sgqlc.types.ArgDict((
                                                   ('ids', sgqlc.types.Arg(sgqlc.types.non_null(
                                                       sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                           graphql_name='ids', default=None)),
    ...
    delete_message_templates_of_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                           graphql_name='deleteMessageTemplatesOfTenant',
                                                           args=sgqlc.types.ArgDict((
                                                               ('ids', sgqlc.types.Arg(
                                                                   sgqlc.types.list_of(sgqlc.types.non_null(String)),
                                                                   graphql_name='ids', default=None)),
                                                               ('tenant_id',
                                                                sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                graphql_name='tenantId', default=None)),
                                                           ))
                                                           )
    delete_meta_template = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteMetaTemplate',
                                             args=sgqlc.types.ArgDict((
                                                 ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                        default=None)),
                                             ))
                                             )
    delete_organization = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteOrganization',
                                            args=sgqlc.types.ArgDict((
                                                ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                       default=None)),
                                            ))
    ...
    delete_role = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteRole', args=sgqlc.types.ArgDict((
        ('ids',
         sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))), graphql_name='ids',
                         default=None)),
    ))
                                    )
    delete_table_fields_config = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                   graphql_name='deleteTableFieldsConfig', args=sgqlc.types.ArgDict((
            ('key', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='key', default=None)),
        ))
                                                   )
    delete_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteTenant',
                                      args=sgqlc.types.ArgDict((
                                          ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                 default=None)),
                                      ))
                                      )
    delete_users = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleteUsers',
                                     args=sgqlc.types.ArgDict((
                                         ('ids', sgqlc.types.Arg(
    ...
    disable_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='disableTenant',
                                       args=sgqlc.types.ArgDict((
                                           ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                  default=None)),
                                       ))
                                       )
    disable_users = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='disableUsers',
                                      args=sgqlc.types.ArgDict((
                                          ('ids', sgqlc.types.Arg(
                                              sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                              graphql_name='ids', default=None)),
    ...
    duplicate_uccform_structure = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                    graphql_name='duplicateUCCFormStructure', args=sgqlc.types.ArgDict((
            ('input',
             sgqlc.types.Arg(sgqlc.types.non_null(DuplicateUCCFormStructureInput), graphql_name='input', default=None)),
        ))
                                                    )
    enable_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='enableTenant',
                                      args=sgqlc.types.ArgDict((
                                          ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                 default=None)),
                                      ))
                                      )
    enable_users = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='enableUsers',
                                     args=sgqlc.types.ArgDict((
                                         ('ids', sgqlc.types.Arg(
                                             sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                             graphql_name='ids', default=None)),
    ...
    offline_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='offlineAppVersion',
                                            args=sgqlc.types.ArgDict((
                                                ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                       default=None)),
                                            ))
                                            )
    online_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='onlineAppVersion',
                                           args=sgqlc.types.ArgDict((
                                               ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                      default=None)),
                                           ))
                                           )
    overwrite_message_template = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                   graphql_name='overwriteMessageTemplate', args=sgqlc.types.ArgDict((
            ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id', default=None)),
        ))
                                                   )
    read_all_inbox_messages = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='readAllInboxMessages',
                                                args=sgqlc.types.ArgDict((
                                                    ('source_app_keys',
                                                     sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)),
                                                                     graphql_name='sourceAppKeys', default=None)),
                                                ))
                                                )
    read_inbox_messages = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='readInboxMessages',
                                            args=sgqlc.types.ArgDict((
                                                ('ids', sgqlc.types.Arg(sgqlc.types.non_null(
                                                    sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                        graphql_name='ids', default=None)),
    ...
    remove_authorization_rules_of_user = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                           graphql_name='removeAuthorizationRulesOfUser',
                                                           args=sgqlc.types.ArgDict((
                                                               ('ids', sgqlc.types.Arg(
                                                                   sgqlc.types.non_null(sgqlc.types.list_of(String)),
                                                                   graphql_name='ids', default=None)),
                                                               ('user_id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                           graphql_name='userId',
                                                                                           default=None)),
                                                           ))
                                                           )
    reset_app_client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='resetAppClientSecret',
                                                args=sgqlc.types.ArgDict((
                                                    ('id',
                                                     sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                     default=None)),
    ...
    reset_authentication_source = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                    graphql_name='resetAuthenticationSource', args=sgqlc.types.ArgDict((
            ('company_uid', sgqlc.types.Arg(String, graphql_name='companyUID', default=None)),
        ))
                                                    )
    reset_tenant_owner_password = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                    graphql_name='resetTenantOwnerPassword', args=sgqlc.types.ArgDict((
            ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId', default=None)),
            ('user_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='userId', default=None)),
        ))
                                                    )
    reset_user_password = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='resetUserPassword',
                                            args=sgqlc.types.ArgDict((
                                                ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                       default=None)),
                                            ))
                                            )
    set_admin_users = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='setAdminUsers',
                                        args=sgqlc.types.ArgDict((
                                            ('ids', sgqlc.types.Arg(
                                                sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                graphql_name='ids', default=None)),
    ...
    set_authorization_rules_to_role = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                        graphql_name='setAuthorizationRulesToRole',
                                                        args=sgqlc.types.ArgDict((
                                                            ('input', sgqlc.types.Arg(
                                                                sgqlc.types.non_null(SetAuthorizationRulesToRoleInput),
                                                                graphql_name='input', default=None)),
                                                        ))
                                                        )
    set_authorization_rules_to_user = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                        graphql_name='setAuthorizationRulesToUser',
                                                        args=sgqlc.types.ArgDict((
                                                            ('input', sgqlc.types.Arg(
                                                                sgqlc.types.non_null(SetAuthorizationRulesToUserInput),
                                                                graphql_name='input', default=None)),
                                                        ))
                                                        )
    set_channel_of_message_templates = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                         graphql_name='setChannelOfMessageTemplates',
                                                         args=sgqlc.types.ArgDict((
                                                             ('channel_id',
                                                              sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                              graphql_name='channelId', default=None)),
                                                             ('message_template_ids', sgqlc.types.Arg(
                                                                 sgqlc.types.non_null(
                                                                     sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                 graphql_name='messageTemplateIds', default=None)),
                                                             ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                           graphql_name='tenantId',
                                                                                           default=None)),
                                                         ))
                                                         )
    set_channels_of_message_template = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                         graphql_name='setChannelsOfMessageTemplate',
                                                         args=sgqlc.types.ArgDict((
                                                             ('channel_ids', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                 sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                                             graphql_name='channelIds',
                                                                                             default=None)),
                                                             ('message_template_id',
                                                              sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                              graphql_name='messageTemplateId',
                                                                              default=None)),
                                                             ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                           graphql_name='tenantId',
                                                                                           default=None)),
    ...
    set_permissions_to_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='setPermissionsToTenant',
                                                  args=sgqlc.types.ArgDict((
                                                      ('input',
                                                       sgqlc.types.Arg(sgqlc.types.non_null(SetPermissionToTenantInput),
                                                                       graphql_name='input', default=None)),
                                                  ))
                                                  )
    set_table_fields_config = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='setTableFieldsConfig',
                                                args=sgqlc.types.ArgDict((
                                                    ('input',
                                                     sgqlc.types.Arg(sgqlc.types.non_null(SetTableFieldsConfigInput),
                                                                     graphql_name='input', default=None)),
                                                ))
                                                )
    set_uccform_structure = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='setUCCFormStructure',
                                              args=sgqlc.types.ArgDict((
                                                  ('input',
                                                   sgqlc.types.Arg(SetUCCFormStructureInput, graphql_name='input',
                                                                   default=None)),
                                              ))
                                              )
    set_workbench = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='setWorkbench',
                                      args=sgqlc.types.ArgDict((
                                          ('input', sgqlc.types.Arg(
    ...
    transfer_tenant_owner = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='transferTenantOwner',
                                              args=sgqlc.types.ArgDict((
                                                  ('target_user_id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                     graphql_name='targetUserId',
                                                                                     default=None)),
                                              ))
                                              )
    un_assign_app_permissions = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='unAssignAppPermissions',
                                                  args=sgqlc.types.ArgDict((
                                                      ('input', sgqlc.types.Arg(
                                                          sgqlc.types.non_null(UnAssignAppPermissionsInput),
                                                          graphql_name='input', default=None)),
                                                  ))
                                                  )
    un_assign_tenant_apps = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='unAssignTenantApps',
                                              args=sgqlc.types.ArgDict((
                                                  ('input',
                                                   sgqlc.types.Arg(sgqlc.types.non_null(UnAssignTenantAppsInput),
                                                                   graphql_name='input', default=None)),
                                              ))
                                              )
    ...
    unset_admin_users = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='unsetAdminUsers',
                                          args=sgqlc.types.ArgDict((
                                              ('ids', sgqlc.types.Arg(sgqlc.types.non_null(
                                                  sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                                                      graphql_name='ids', default=None)),
    ...
    update_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateAppVersion',
                                           args=sgqlc.types.ArgDict((
                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(UpdateAppVersionInput),
                                                                         graphql_name='input', default=None)),
                                           ))
                                           )
    update_authorization_rules_of_user = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                           graphql_name='updateAuthorizationRulesOfUser',
                                                           args=sgqlc.types.ArgDict((
                                                               ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                   UpdateAuthorizationRulesOfUserInput),
                                                                                         graphql_name='input',
                                                                                         default=None)),
                                                           ))
                                                           )
    update_enterprise_app = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateEnterpriseApp',
                                              args=sgqlc.types.ArgDict((
                                                  ('input',
                                                   sgqlc.types.Arg(sgqlc.types.non_null(UpdateEnterpriseAppInput),
                                                                   graphql_name='input', default=None)),
                                              ))
                                              )
    ...
    update_meta_channel = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateMetaChannel',
                                            args=sgqlc.types.ArgDict((
                                                ('input', sgqlc.types.Arg(sgqlc.types.non_null(UpdateMetaChannelInput),
                                                                          graphql_name='input', default=None)),
                                            ))
                                            )
    update_meta_template = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateMetaTemplate',
                                             args=sgqlc.types.ArgDict((
                                                 ('input',
                                                  sgqlc.types.Arg(sgqlc.types.non_null(UpdateMetaTemplateInput),
                                                                  graphql_name='input', default=None)),
                                             ))
                                             )
    update_oauth2_authentication_configuration = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                                   graphql_name='updateOAuth2AuthenticationConfiguration',
                                                                   args=sgqlc.types.ArgDict((
                                                                       ('input', sgqlc.types.Arg(sgqlc.types.non_null(
                                                                           UpdateOAuth2AuthenticationConfigurationInput),
                                                                                                 graphql_name='input',
                                                                                                 default=None)),
                                                                   ))
                                                                   )
    update_open_idconnect1_authentication_configuration = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                                            graphql_name='updateOpenIDConnect1AuthenticationConfiguration',
                                                                            args=sgqlc.types.ArgDict((
                                                                                ('input', sgqlc.types.Arg(
                                                                                    sgqlc.types.non_null(
                                                                                        UpdateOpenIDConnect1AuthenticationConfigurationInput),
                                                                                    graphql_name='input',
                                                                                    default=None)),
                                                                            ))
                                                                            )
    update_organization = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateOrganization',
                                            args=sgqlc.types.ArgDict((
                                                ('input', sgqlc.types.Arg(sgqlc.types.non_null(UpdateOrganizationInput),
                                                                          graphql_name='input', default=None)),
                                            ))
                                            )
    ...
    update_status_of_template = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateStatusOfTemplate',
                                                  args=sgqlc.types.ArgDict((
                                                      ('id',
                                                       sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                       default=None)),
                                                      ('status', sgqlc.types.Arg(sgqlc.types.non_null(TemplateStatus),
                                                                                 graphql_name='status', default=None)),
                                                  ))
                                                  )
    update_tenant = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='updateTenant',
                                      args=sgqlc.types.ArgDict((
                                          ('input', sgqlc.types.Arg(sgqlc.types.non_null(UpdateTenantInput),
                                                                    graphql_name='input', default=None)),
                                      ))
                                      )
...
class OldRole(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    permissions = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('Permission'))),
                                    graphql_name='permissions')
...
class OldRoleList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(OldRole))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class Organization(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'code', 'current_user_count', 'has_children', 'id', 'is_deleted', 'manager', 'name', 'parent_id', 'path_name',
    'total_user_count')
    code = sgqlc.types.Field(String, graphql_name='code')
...
class OrganizationList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Organization))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class Permission(sgqlc.types.Type):
    ...
    app = sgqlc.types.Field(sgqlc.types.non_null(App), graphql_name='app')
    data_ranges = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('PermissionDataRange')),
                                    graphql_name='dataRanges')
    dependencies = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
...
class Query(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'log_list', 'admin_user_list', 'all_authorization_rules_of_role', 'all_permissions_of_user', 'apis', 'app_groups',
    'app_menu_list', 'app_version_list', 'assignable_managers_of_organization',
    'assignable_meta_template_list_of_tenant', 'assignable_permissions_of_tenant', 'assigned_permissions_of_app',
    'authentication_configuration', 'authentication_source', 'authorization_rule_and_dependencies',
    'authorization_rule_dependent_by', 'bi_issue_issue', 'children_of_department', 'cities', 'city_companies',
    'companies', 'company_bidatasource_list', 'company_bidatasource_tree', 'counties', 'department_list',
    'department_tree', 'direct_authorization_rules_of_user', 'inbox_message', 'inbox_message_list',
    'is_create_app_version_allowed', 'is_permission_changed_of_latest_app_version', 'login_configuration', 'me',
    'menu_visit_history_list', 'message_channels_of_tenant', 'message_template_list_of_tenant', 'meta_channels',
    'meta_template', 'meta_template_event_exists', 'meta_template_list', 'my_app_list', 'my_tenant',
    'my_tenant_app_list', 'organization', 'organization_by_code', 'organization_code_exists', 'organization_list',
    'organization_name_exists_in_siblings', 'organization_tree_nodes', 'permissions', 'permissions_of_tenant',
    'provinces', 'recent_app', 'role', 'role_list', 'role_name_exists', 'root_organization', 'stared_apps',
    'system_log_action', 'system_log_list', 'table_fields_config', 'tenant', 'tenant_app_list', 'tenant_code_exists',
    'tenant_industry_tree_nodes', 'tenant_list', 'tenant_name_exists', 'tenant_uscc_exists', 'ucc_form_structure',
    'ucc_form_structure_json_schema', 'unread_message_apps', 'upload_config', 'upload_configs', 'user',
    'user_account_exists', 'user_list', 'workbench', 'workbench_card_data', 'workbench_card_option')
    log_list = sgqlc.types.Field(sgqlc.types.non_null('LogList'), graphql_name='LogList', args=sgqlc.types.ArgDict((
        ...
        ('order_by',
         sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name='orderBy', default=None)),
    ))
                                 )
    admin_user_list = sgqlc.types.Field(sgqlc.types.non_null('UserList'), graphql_name='adminUserList',
                                        args=sgqlc.types.ArgDict((
                                            ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                            ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                            ('order_by',
    ...
    all_authorization_rules_of_role = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AuthorizationRule))),
        graphql_name='allAuthorizationRulesOfRole', args=sgqlc.types.ArgDict((
    ...
    all_permissions_of_user = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Permission))),
        graphql_name='allPermissionsOfUser', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(PermissionFilterInput, graphql_name='filter', default=None)),
            ('user_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='userId', default=None)),
        ))
        )
    apis = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Api))), graphql_name='apis',
                             args=sgqlc.types.ArgDict((
                                 ('filter', sgqlc.types.Arg(ApiFilterInput, graphql_name='filter', default=None)),
                             ))
                             )
    app_groups = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AppGroup))),
                                   graphql_name='appGroups')
    app_menu_list = sgqlc.types.Field(sgqlc.types.non_null(AppMenuList), graphql_name='appMenuList',
                                      args=sgqlc.types.ArgDict((
                                          ('filter',
                                           sgqlc.types.Arg(MenuListFilterInput, graphql_name='filter', default=None)),
                                          ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                          ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                          ('order_by',
                                           sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)),
    ...
    app_version_list = sgqlc.types.Field(sgqlc.types.non_null(AppVersionList), graphql_name='appVersionList',
                                         args=sgqlc.types.ArgDict((
                                             ('filter',
                                              sgqlc.types.Arg(AppVersionListFilterInput, graphql_name='filter',
                                                              default=None)),
                                             ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                             ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                             ('order_by',
    ...
    assignable_managers_of_organization = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('User'))),
        graphql_name='assignableManagersOfOrganization', args=sgqlc.types.ArgDict((
            ('organization_id',
             sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='organizationId', default=None)),
        ))
        )
    assignable_meta_template_list_of_tenant = sgqlc.types.Field(sgqlc.types.non_null(MetaTemplateList),
                                                                graphql_name='assignableMetaTemplateListOfTenant',
                                                                args=sgqlc.types.ArgDict((
                                                                    ('filter', sgqlc.types.Arg(MetaTemplateListInput,
                                                                                               graphql_name='filter',
                                                                                               default=None)),
                                                                    ('limit', sgqlc.types.Arg(Int, graphql_name='limit',
                                                                                              default=None)),
                                                                    ('offset',
                                                                     sgqlc.types.Arg(Int, graphql_name='offset',
                                                                                     default=None)),
    ...
    assignable_permissions_of_tenant = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Permission))),
        graphql_name='assignablePermissionsOfTenant', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(PermissionFilterInput, graphql_name='filter', default=None)),
            ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId', default=None)),
        ))
        )
    assigned_permissions_of_app = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Permission))),
        graphql_name='assignedPermissionsOfApp', args=sgqlc.types.ArgDict((
            ('app_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='appId', default=None)),
        ))
        )
    authentication_configuration = sgqlc.types.Field(AuthenticationConfiguration,
                                                     graphql_name='authenticationConfiguration')
    authentication_source = sgqlc.types.Field(AuthenticationSource, graphql_name='authenticationSource',
                                              args=sgqlc.types.ArgDict((
                                                  ('company_id',
                                                   sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='companyId',
                                                                   default=None)),
                                              ))
                                              )
    authorization_rule_and_dependencies = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(AuthorizationRule)), graphql_name='authorizationRuleAndDependencies',
        args=sgqlc.types.ArgDict((
            ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id', default=None)),
        ))
        )
    authorization_rule_dependent_by = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AuthorizationRule))),
        graphql_name='authorizationRuleDependentBy', args=sgqlc.types.ArgDict((
            ('rule_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='ruleId', default=None)),
        ))
        )
    bi_issue_issue = sgqlc.types.Field(sgqlc.types.list_of(BIResult), graphql_name='biIssueIssue',
                                       args=sgqlc.types.ArgDict((
                                           ('filter',
                                            sgqlc.types.Arg(BIFilterInput, graphql_name='filter', default=None)),
                                       ))
                                       )
    children_of_department = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Department))),
        graphql_name='childrenOfDepartment', args=sgqlc.types.ArgDict((
    ...
    cities = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(City)), graphql_name='cities',
                               args=sgqlc.types.ArgDict((
                                   ('filter',
                                    sgqlc.types.Arg(sgqlc.types.non_null(CityFilterInput), graphql_name='filter',
                                                    default=None)),
                               ))
                               )
    city_companies = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(City)), graphql_name='cityCompanies')
    companies = sgqlc.types.Field(sgqlc.types.non_null(CompanyList), graphql_name='companies',
                                  args=sgqlc.types.ArgDict((
    ...
    company_bidatasource_list = sgqlc.types.Field(sgqlc.types.non_null(CompanyBIDatasourceList),
                                                  graphql_name='companyBIDatasourceList', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(CompanyBIDatasourceFilter, graphql_name='filter', default=None)),
            ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
            ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
        ))
                                                  )
    company_bidatasource_tree = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(AppBIDatasourceList)),
                                                  graphql_name='companyBIDatasourceTree', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(CompanyBIDatasourceFilter, graphql_name='filter', default=None)),
        ))
                                                  )
    counties = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(County)), graphql_name='counties',
                                 args=sgqlc.types.ArgDict((
                                     ('filter',
                                      sgqlc.types.Arg(sgqlc.types.non_null(CountyFilterInput), graphql_name='filter',
                                                      default=None)),
                                 ))
                                 )
    department_list = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(Department)),
                                        graphql_name='departmentList', args=sgqlc.types.ArgDict((
            (
    ...
    department_tree = sgqlc.types.Field(sgqlc.types.non_null(JSONString), graphql_name='departmentTree',
                                        args=sgqlc.types.ArgDict((
                                            ('filter', sgqlc.types.Arg(DepartmentTreeFilter, graphql_name='filter',
                                                                       default=None)),
                                        ))
                                        )
    direct_authorization_rules_of_user = sgqlc.types.Field(sgqlc.types.non_null(AuthorizationRuleList),
                                                           graphql_name='directAuthorizationRulesOfUser',
                                                           args=sgqlc.types.ArgDict((
                                                               ('filter', sgqlc.types.Arg(AuthorizationRuleFilterInput,
                                                                                          graphql_name='filter',
                                                                                          default=None)),
                                                               ('limit', sgqlc.types.Arg(Int, graphql_name='limit',
                                                                                         default=None)),
                                                               ('offset', sgqlc.types.Arg(Int, graphql_name='offset',
                                                                                          default=None)),
    ...
    inbox_message = sgqlc.types.Field(sgqlc.types.non_null(InboxMessage), graphql_name='inboxMessage',
                                      args=sgqlc.types.ArgDict((
                                          ('id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='id',
                                                                 default=None)),
                                      ))
                                      )
    inbox_message_list = sgqlc.types.Field(sgqlc.types.non_null(InboxMessageList), graphql_name='inboxMessageList',
                                           args=sgqlc.types.ArgDict((
                                               ('filter',
                                                sgqlc.types.Arg(InboxMessageFilterInput, graphql_name='filter',
                                                                default=None)),
                                               ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                               ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                               ('order_by',
    ...
    is_create_app_version_allowed = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                      graphql_name='isCreateAppVersionAllowed',
                                                      args=sgqlc.types.ArgDict((
                                                          ('app_id', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                     graphql_name='appId',
                                                                                     default=None)),
                                                      ))
                                                      )
    is_permission_changed_of_latest_app_version = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                                    graphql_name='isPermissionChangedOfLatestAppVersion',
                                                                    args=sgqlc.types.ArgDict((
                                                                        ('app_id',
                                                                         sgqlc.types.Arg(String, graphql_name='appId',
                                                                                         default=None)),
                                                                    ))
                                                                    )
    login_configuration = sgqlc.types.Field(sgqlc.types.non_null(LoginConfiguration), graphql_name='loginConfiguration',
                                            args=sgqlc.types.ArgDict((
                                                ('tenant_code', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                graphql_name='tenantCode',
                                                                                default=None)),
                                            ))
                                            )
    me = sgqlc.types.Field(sgqlc.types.non_null('User'), graphql_name='me')
    menu_visit_history_list = sgqlc.types.Field(sgqlc.types.non_null(MenuVisitHistoryList),
                                                graphql_name='menuVisitHistoryList', args=sgqlc.types.ArgDict((
    ...
    message_channels_of_tenant = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MessageChannel))),
        graphql_name='messageChannelsOfTenant', args=sgqlc.types.ArgDict((
            ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId', default=None)),
        ))
        )
    message_template_list_of_tenant = sgqlc.types.Field(sgqlc.types.non_null(MessageTemplateList),
                                                        graphql_name='messageTemplateListOfTenant',
                                                        args=sgqlc.types.ArgDict((
                                                            ('filter', sgqlc.types.Arg(MessageTemplateListInput,
                                                                                       graphql_name='filter',
                                                                                       default=None)),
                                                            ('limit',
    ...
    meta_channels = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MetaChannel))),
                                      graphql_name='metaChannels')
    ...
    meta_template_event_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                   graphql_name='metaTemplateEventExists', args=sgqlc.types.ArgDict((
            ('event', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='event', default=None)),
        ))
                                                   )
    meta_template_list = sgqlc.types.Field(sgqlc.types.non_null(MetaTemplateList), graphql_name='metaTemplateList',
                                           args=sgqlc.types.ArgDict((
                                               ('filter', sgqlc.types.Arg(MetaTemplateListInput, graphql_name='filter',
                                                                          default=None)),
                                               ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                               ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                               ('order_by',
    ...
    my_tenant_app_list = sgqlc.types.Field(sgqlc.types.non_null(AppList), graphql_name='myTenantAppList',
                                           args=sgqlc.types.ArgDict((
                                               ('filter',
                                                sgqlc.types.Arg(MyTenantAppListFilterInput, graphql_name='filter',
                                                                default=None)),
                                               ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                               ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                               ('order_by',
    ...
    organization_code_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='organizationCodeExists',
                                                 args=sgqlc.types.ArgDict((
                                                     ('code',
                                                      sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='code',
                                                                      default=None)),
                                                 ))
                                                 )
    organization_list = sgqlc.types.Field(sgqlc.types.non_null(OrganizationList), graphql_name='organizationList',
                                          args=sgqlc.types.ArgDict((
                                              ('filter',
                                               sgqlc.types.Arg(OrganizationListFilterInput, graphql_name='filter',
                                                               default=None)),
                                              ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                              ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                              ('order_by',
    ...
    organization_name_exists_in_siblings = sgqlc.types.Field(sgqlc.types.non_null(Boolean),
                                                             graphql_name='organizationNameExistsInSiblings',
                                                             args=sgqlc.types.ArgDict((
                                                                 ('name', sgqlc.types.Arg(sgqlc.types.non_null(String),
                                                                                          graphql_name='name',
                                                                                          default=None)),
                                                                 ('parent_id',
                                                                  sgqlc.types.Arg(sgqlc.types.non_null(String),
    ...
    organization_tree_nodes = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Organization))),
        graphql_name='organizationTreeNodes', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(OrganizationTreeNodeFilterInput, graphql_name='filter', default=None)),
        ))
        )
    permissions = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(Permission)), graphql_name='permissions',
                                    args=sgqlc.types.ArgDict((
                                        ('filter',
                                         sgqlc.types.Arg(PermissionFilterInput, graphql_name='filter', default=None)),
                                        ('order_by', sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)),
                                                                     graphql_name='orderBy', default=None)),
                                    ))
                                    )
    permissions_of_tenant = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Permission))), graphql_name='permissionsOfTenant',
        args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(PermissionFilterInput, graphql_name='filter', default=None)),
            ('tenant_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId', default=None)),
        ))
    ...
    recent_app = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(App))),
                                   graphql_name='recentApp', args=sgqlc.types.ArgDict((
    ...
    role_name_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='roleNameExists',
                                         args=sgqlc.types.ArgDict((
                                             ('name', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='name',
                                                                      default=None)),
                                         ))
                                         )
    root_organization = sgqlc.types.Field(sgqlc.types.non_null(Organization), graphql_name='rootOrganization')
    stared_apps = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(App))),
                                    graphql_name='staredApps')
    system_log_action = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                          graphql_name='systemLogAction', args=sgqlc.types.ArgDict((
            ('company_id', sgqlc.types.Arg(ID, graphql_name='companyId', default=None)),
        ))
                                          )
    system_log_list = sgqlc.types.Field(sgqlc.types.non_null('SystemLogList'), graphql_name='systemLogList',
                                        args=sgqlc.types.ArgDict((
                                            ('filter', sgqlc.types.Arg(sgqlc.types.non_null(SystemLogFilterInput),
    ...
    table_fields_config = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('TableFieldConfig'))),
        graphql_name='tableFieldsConfig', args=sgqlc.types.ArgDict((
            ('default_fields_config',
             sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(TableFieldConfigInput))),
                             graphql_name='defaultFieldsConfig', default=None)),
    ...
    tenant_app_list = sgqlc.types.Field(sgqlc.types.non_null(AppList), graphql_name='tenantAppList',
                                        args=sgqlc.types.ArgDict((
                                            ('filter', sgqlc.types.Arg(sgqlc.types.non_null(TenantAppListFilterInput),
                                                                       graphql_name='filter', default=None)),
                                            ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                            ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                            ('order_by',
    ...
    tenant_code_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='tenantCodeExists',
                                           args=sgqlc.types.ArgDict((
                                               ('code',
                                                sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='code',
                                                                default=None)),
    ...
    tenant_industry_tree_nodes = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('TenantIndustry'))),
        graphql_name='tenantIndustryTreeNodes', args=sgqlc.types.ArgDict((
            ('filter', sgqlc.types.Arg(TenantIndustryTreeNodeFilterInput, graphql_name='filter', default=None)),
        ))
        )
    tenant_list = sgqlc.types.Field(sgqlc.types.non_null('TenantList'), graphql_name='tenantList',
                                    args=sgqlc.types.ArgDict((
                                        ('filter',
                                         sgqlc.types.Arg(TenantFilterInput, graphql_name='filter', default=None)),
                                        ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
                                        ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=None)),
                                        ('order_by', sgqlc.types.Arg(sgqlc.types.list_of(sgqlc.types.non_null(String)),
                                                                     graphql_name='orderBy', default=None)),
    ...
    tenant_name_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='tenantNameExists',
                                           args=sgqlc.types.ArgDict((
                                               ('name',
                                                sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='name',
                                                                default=None)),
                                           ))
                                           )
    tenant_uscc_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='tenantUsccExists',
                                           args=sgqlc.types.ArgDict((
                                               ('uscc',
                                                sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='uscc',
                                                                default=None)),
                                           ))
                                           )
    ucc_form_structure = sgqlc.types.Field(sgqlc.types.non_null('UCCFormStructure'), graphql_name='uccFormStructure',
                                           args=sgqlc.types.ArgDict((
                                               ('filter', sgqlc.types.Arg(sgqlc.types.non_null(UCCFormStructureFilter),
                                                                          graphql_name='filter', default=None)),
                                           ))
                                           )
    ucc_form_structure_json_schema = sgqlc.types.Field(sgqlc.types.non_null(JSON),
                                                       graphql_name='uccFormStructureJsonSchema',
                                                       args=sgqlc.types.ArgDict((
                                                           ('filter', sgqlc.types.Arg(
                                                               sgqlc.types.non_null(UCCFormStructureFilter),
                                                               graphql_name='filter', default=None)),
                                                       ))
                                                       )
    unread_message_apps = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(App))),
                                            graphql_name='unreadMessageApps')
    upload_config = sgqlc.types.Field('UploadConfig', graphql_name='uploadConfig', args=sgqlc.types.ArgDict((
        ('name', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='name', default=None)),
    ))
                                      )
    upload_configs = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('UploadConfig')),
                                       graphql_name='uploadConfigs', args=sgqlc.types.ArgDict((
            ('names', sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                                      graphql_name='names', default=None)),
        ))
                                       )
    ...
    user_account_exists = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='userAccountExists',
                                            args=sgqlc.types.ArgDict((
                                                ('account',
                                                 sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='account',
                                                                 default=None)),
                                                ('tenant_id',
                                                 sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='tenantId',
                                                                 default=None)),
                                            ))
                                            )
    ...
    workbench = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('WorkbenchCard'))),
                                  graphql_name='workbench')
    workbench_card_data = sgqlc.types.Field(sgqlc.types.non_null(JSON), graphql_name='workbenchCardData',
                                            args=sgqlc.types.ArgDict((
                                                ('id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='id',
                                                                       default=None)),
                                            ))
                                            )
    workbench_card_option = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('WorkbenchCard'))),
        graphql_name='workbenchCardOption')
...
class SystemLogList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(SystemLog))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class TableConfig(sgqlc.types.Type):
    ...
    fields = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('TableFieldConfig'))),
                               graphql_name='fields')
    key = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='key')
    label = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='label')
...
class Tenant(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'address', 'city', 'code', 'company_id', 'county', 'created_at', 'email', 'id', 'industry', 'name', 'owner',
    'phone', 'province', 'status', 'type', 'uscc')
    address = sgqlc.types.Field(String, graphql_name='address')
...
class TenantList(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('data', 'total_count')
    data = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Tenant))),
                             graphql_name='data')
    total_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='totalCount')
...
class UCCMetaMultiRadio(sgqlc.types.Type):
    ...
    field_type = sgqlc.types.Field(sgqlc.types.non_null(UCCFieldType), graphql_name='fieldType')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    option = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
                               graphql_name='option')
...
class UCCMetaText(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'default_num', 'default_str', 'field_type', 'hint', 'id', 'label', 'max', 'min', 'round', 'type', 'unit',
    'zeroable')
    default_num = sgqlc.types.Field(Float, graphql_name='defaultNum')
    default_str = sgqlc.types.Field(String, graphql_name='defaultStr')
    field_type = sgqlc.types.Field(sgqlc.types.non_null(UCCFieldType), graphql_name='fieldType')
...
class User(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = (
    'account', 'all_authorizations', 'avatar', 'created_at', 'email', 'id', 'is_account_enabled', 'is_admin',
    'is_user_enabled', 'name', 'organizations', 'phone_number', 'remark', 'roles', 'tenant', 'updated_at')
    account = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='account')
    all_authorizations = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Authorization))),
        graphql_name='allAuthorizations')
    avatar = sgqlc.types.Field(Image, graphql_name='avatar')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(Timestamp), graphql_name='createdAt')
    email = sgqlc.types.Field(String, graphql_name='email')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    ...
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    organizations = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Organization))),
                                      graphql_name='organizations')
    phone_number = sgqlc.types.Field(String, graphql_name='phoneNumber')
    remark = sgqlc.types.Field(String, graphql_name='remark')
    roles = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Role))),
                              graphql_name='roles')
...
class AuthenticationSourceLDAP3(sgqlc.types.Type, AuthenticationSource):
    __schema__ = platform_schema
    __field_names__ = (
    'bind_dn', 'bind_password', 'email_attribute', 'encryption_method', 'host', 'name_attribute', 'phone_attribute',
    'port', 'uid_attribute', 'user_search_base_dn', 'user_search_filter')
    bind_dn = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='bindDN')
    bind_password = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='bindPassword')
    email_attribute = sgqlc.types.Field(String, graphql_name='emailAttribute')
    encryption_method = sgqlc.types.Field(sgqlc.types.non_null(LDAP3EncryptionMethod), graphql_name='encryptionMethod')
...
class AuthenticationSourceOAuth2(sgqlc.types.Type, AuthenticationSource):
    __schema__ = platform_schema
    __field_names__ = (
    'authorization_url', 'client_id', 'client_secret', 'email_attribute', 'name_attribute', 'phone_attribute', 'scope',
    'token_url', 'uid_attribute', 'user_info_url')
    authorization_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='authorizationURL')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientID')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    email_attribute = sgqlc.types.Field(String, graphql_name='emailAttribute')
...
class AuthenticationSourceOpenIDConnect1(sgqlc.types.Type, AuthenticationSource):
    __schema__ = platform_schema
    __field_names__ = (
    'authorization_url', 'client_id', 'client_secret', 'configuration_method', 'configuration_url', 'email_attribute',
    'jwks_url', 'name_attribute', 'phone_attribute', 'scope', 'token_url', 'uid_attribute')
    authorization_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='authorizationURL')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientID')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    configuration_method = sgqlc.types.Field(sgqlc.types.non_null(OpenIDConnect1ConfigurationMethod),
...
class OAuth2AuthenticationConfiguration(sgqlc.types.Type, AuthenticationConfiguration):
    ...
    __field_names__ = (
    'access_token_attribute_path', 'account_attribute_path', 'authorization_url', 'client_authentication_method',
    'client_id', 'client_secret', 'do_update_local_user_info_when_login', 'email_attribute_path', 'name_attribute_path',
    'phone_number_attribute_path', 'scope', 'support_state', 'token_response_format', 'token_url',
    'user_info_authentication_method', 'user_info_request_method', 'user_info_response_format', 'user_info_url')
    access_token_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                    graphql_name='accessTokenAttributePath')
    account_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='accountAttributePath')
    authorization_url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='authorizationUrl')
...
class OAuth2LoginConfiguration(sgqlc.types.Type, LoginConfiguration):
    ...
    authentication_configuration_name = sgqlc.types.Field(sgqlc.types.non_null(String),
                                                          graphql_name='authenticationConfigurationName')
...
class OpenIDConnect1AuthenticationConfiguration(sgqlc.types.Type, AuthenticationConfiguration):
    ...
    __field_names__ = (
    'account_attribute_path', 'client_id', 'client_secret', 'configuration_url', 'do_update_local_user_info_when_login',
    'email_attribute_path', 'name_attribute_path', 'phone_number_attribute_path', 'scope')
    account_attribute_path = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='accountAttributePath')
    client_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientId')
    client_secret = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='clientSecret')
    configuration_url = sgqlc.types.Field(String, graphql_name='configurationUrl')
...
class UCCMeta(sgqlc.types.Union):
    __schema__ = platform_schema
    __types__ = (
    UCCMetaDate, UCCMetaLabel, UCCMetaMultiRadio, UCCMetaRadio, UCCMetaRange, UCCMetaSelectBox, UCCMetaSet, UCCMetaText)
