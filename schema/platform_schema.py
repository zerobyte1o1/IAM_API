...
class Mutation(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('_dummy', 'active_message_channel', 'add_meta_templates_to_tenant', 'assign_app_permissions', 'assign_tenant_apps', 'change_my_password', 'company_login', 'configure_authentication_source_ldap3', 'configure_authentication_source_oauth2', 'configure_authentication_source_open_idconnect1', 'configure_authentication_source_saml2', 'create_app_version', 'create_company_bidatasource', 'create_enterprise_app', 'create_file', 'create_files', 'create_image', 'create_images', 'create_market_file', 'create_market_files', 'create_meta_template', 'create_oauth2_authentication_configuration', 'create_open_idconnect1_authentication_configuration', 'create_organization', 'create_role', 'create_tenant', 'create_tenant_owner', 'create_user', 'deactivate_message_channel', 'delete_app_version', 'delete_authentication_configuration', 'delete_company_bidatasource', 'delete_enterprise_apps', 'delete_message_templates_of_tenant', 'delete_meta_template', 'delete_organization', 'delete_role', 'delete_table_fields_config', 'delete_tenant', 'delete_users', 'disable_tenant', 'disable_users', 'duplicate_uccform_structure', 'enable_tenant', 'enable_users', 'login', 'logout', 'offline_app_version', 'online_app_version', 'overwrite_message_template', 'read_all_inbox_messages', 'read_inbox_messages', 'remove_authorization_rules_of_user', 'reset_app_client_secret', 'reset_authentication_source', 'reset_tenant_owner_password', 'reset_user_password', 'set_admin_users', 'set_authorization_rules_to_role', 'set_authorization_rules_to_user', 'set_channel_of_message_templates', 'set_channels_of_message_template', 'set_permissions_to_tenant', 'set_table_fields_config', 'set_uccform_structure', 'set_workbench', 'star_app', 'transfer_tenant_owner', 'un_assign_app_permissions', 'un_assign_tenant_apps', 'un_star_app', 'unset_admin_users', 'update_app_version', 'update_authorization_rules_of_user', 'update_enterprise_app', 'update_me', 'update_meta_channel', 'update_meta_template', 'update_oauth2_authentication_configuration', 'update_open_idconnect1_authentication_configuration', 'update_organization', 'update_role', 'update_status_of_template', 'update_tenant', 'update_user', 'visit_app', 'visit_menu')
