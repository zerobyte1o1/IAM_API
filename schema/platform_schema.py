...
class EamFieldInput(sgqlc.types.Input):
    ...
    role = sgqlc.types.Field(sgqlc.types.list_of(Int), graphql_name='role')
...
class User(sgqlc.types.Type):
    __schema__ = platform_schema
    __field_names__ = ('account', 'all_authorizations', 'avatar', 'created_at', 'email', 'id', 'is_account_enabled', 'is_admin', 'is_user_enabled', 'name', 'organizations', 'phone_number', 'remark', 'roles', 'tenant', 'thing_group', 'updated_at')
    account = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='account')
